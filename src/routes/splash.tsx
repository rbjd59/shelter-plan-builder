  ...
  head: () => ({
    meta: [
      { title: "DetencionDefensa.com — Bienvenidos · Welcome · Byenvini" },
      {
        name: "description",
        content:
          "A pre-detention defense plan for immigrant working families. Emergency app and attorney-reviewed documents at no cost during the community crisis. Operated by Sorrentino Law Firm PLLC under license; DetencionDefensa.com, Inc. is the technology operator only.",
      },
    ],
  }),
