...
const COPY = {
  en: {
    ...
    optAsent: "Sent.",
    optB: "Lock in the vault — release only on NOTIFY FAMILY",
    optBdesc: "$5/month encrypted storage. We hold the packet and only release it to your designated person the moment you activate NOTIFY FAMILY. You keep 100% control until then.",
  ...
  es: {
    ...
    optAsent: "Enviado.",
    optB: "Guardar en la bóveda — liberar solo con AVISAR A FAMILIA",
    optBdesc: "$5/mes de almacenamiento cifrado. Conservamos el paquete y solo lo liberamos a su persona designada cuando active AVISAR A FAMILIA. Usted mantiene 100% del control hasta entonces.",
  ...
  ht: {
    ...
    optAsent: "Voye.",
    optB: "Sere nan kòfrefò — lage sèlman ak AVIZE FANMI",
    optBdesc: "$5/mwa estokaj chiffre. Nou kenbe pakè a epi nou lage l bay moun ou chwazi a sèlman lè ou aktive AVIZE FANMI. Ou gen 100% kontwòl jiskaske lè sa a.",
