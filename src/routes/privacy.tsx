...
const COPY = {
  en: {
    ...
    s11p1: "Sorrentino Law Firm PLLC operates this site and app under license from DetencionDefensa.com, Inc. and provides all legal services. DetencionDefensa.com, Inc. is strictly the technology developer and operator of the notification, translation, and typing tools; it is not a law firm and gives no legal advice. Your intake is handled by the Company only as the Firm's disclosed agent, so attorney-client privilege attaches through the Firm. An attorney-client relationship with the Firm begins when the Firm accepts your matter and you sign its limited-scope engagement letter. The pre-filled federal court forms generated by the app are based on public-domain U.S. federal templates and the information you provide; their accuracy depends on the accuracy of your input. We strongly encourage you to consult a licensed attorney to review any document before filing.",
  ...
  es: {
    ...
    s11p1: "Sorrentino Law Firm PLLC opera este sitio y la aplicación bajo licencia de DetencionDefensa.com, Inc. y presta todos los servicios legales. DetencionDefensa.com, Inc. es estrictamente el desarrollador tecnológico y operador de las herramientas de notificación, traducción y mecanografía; no es una firma de abogados y no brinda asesoría legal. Su información de admisión es tratada por la empresa únicamente como agente divulgado de la Firma, por lo que el privilegio abogado-cliente se aplica a través de la Firma. La relación abogado-cliente con la Firma comienza cuando la Firma acepta su asunto y usted firma su carta de contratación de alcance limitado. Los formularios federales prellenados generados por la app se basan en plantillas federales de EE. UU. de dominio público y en la información que usted proporciona; su exactitud depende de la exactitud de su entrada. Le recomendamos encarecidamente consultar a un abogado con licencia para revisar cualquier documento antes de presentarlo.",
    copyright: "\u00a9 2026 DetencionDefensa",
  },
  ht: {
    ...
    s11title: "Dega Legal",
    s11p1: "Sorrentino Law Firm PLLC ap opere sit sa a ak aplikasyon an anba yon lisans DetencionDefensa.com, Inc. bay, epi se li ki bay tout sèvis legal. DetencionDefensa.com, Inc. se sèlman devlopè teknoloji a ak operatè zouti notifikasyon, tradiksyon, ak daktilografi yo; li pa yon kabinè avoka epi li pa bay konsèy legal. Se konpayi an ki jere admisyon w, men sèlman kòm ajan deklare Kabinè a, konsa privilèj avoka-kliyan aplike atravè Kabinè a. Relasyon avoka-kliyan ak Kabinè a kòmanse lè Kabinè a aksepte dosye w epi ou siyen lèt angajman limite li a. Fòm federal ranpli davans yo aplikasyon an jenere yo baze sou modèl federal domèn piblik Etazini ak enfòmasyon ou bay; egzaktitid yo depann de egzaktitid antre ou. Nou ankouraje w fòtman konsilte yon avoka ki gen lisans pou revize nenpòt dokiman anvan ou depoze l.",
    copyright: "\u00a9 2026 DetencionDefensa",
  },
} as const;
