...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "DetencionDefensa.com, Inc. — a pre-detention defense plan for immigrant working families. Emergency app $10/month; attorney-reviewed documents at no charge. Not a law firm." },
      { name: "author", content: "DetencionDefensa.com, Inc." },
      { property: "og:title", content: "DetencionDefensa.com — Pre-Detention Defense Plan" },
      { property: "og:description", content: "Pre-detention defense plan for immigrant working families. Emergency app $10/month; attorney-reviewed documents at no charge." },
