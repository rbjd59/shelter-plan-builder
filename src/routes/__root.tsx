...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Pre-detention defense plan for immigrant working families. Emergency app and attorney-reviewed documents at no cost during the community crisis." },
    ],
    links: [
