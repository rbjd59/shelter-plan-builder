...
const T = {
  es: {
    ...
    hero: {
      ...
      sub: "Plan diseñado para impugnar la detención ilegal bajo las políticas recientes del DHS en los tribunales con un clic de botón - No permanezca bajo custodia meses antes de solicitar una audiencia de liberación.\n\nNo está diseñado para personas con antecedentes penales, antecedentes de pandillas, historial de violencia, o que de otro modo no sean aptas para la residencia en EE. UU.",
      cta: "Empezar gratis →",
  ...
  en: {
    ...
    hero: {
      ...
      sub: "Plan designed to challenge illegal detention under recent DHS policies in the courts at a click of a button - Do Not sit in custody months before requesting a release hearing.\n\nNot designed for persons with a criminal background, gang background, violent history, or otherwise unsuitable for residency in the US.",
      cta: "Start free →",
  ...
  ht: {
    ...
    hero: {
      ...
      sub: "Plan konsevwa pou defi anpèsman ilegal anba politik DHS resan yo nan tribunal yo ak yon sèl klik - Pa rezan nan kazèn mwa avan yo mande yon odyans liberasyon.\n\nPa fèt pou moun ki gen antsedan kriminèl, antsedan gang, istwa vyolans, oubyen ki pa otreman apwopriye pou rezidans nan Etazini.",
      cta: "Kòmanse gratis →",
