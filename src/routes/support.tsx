...
const COPY = {
  en: {
    ...
    a4: "Tell them to check their spam folder. The email comes from legal@detenciondefensa.com. If it is still missing, email us and we will resend it.",
    q5: "Is this app free?",
  ...
  es: {
    ...
    a4: "Dígale que revise su carpeta de spam. El correo viene de legal@detenciondefensa.com. Si aún no aparece, escríbanos y lo reenviaremos.",
  ...
  ht: {
    ...
    a4: "Di li tcheke katye spam li. Imèl la soti nan legal@detenciondefensa.com. Si li toujou pa parèt, ekri nou epi n ap voye l ankò.",
