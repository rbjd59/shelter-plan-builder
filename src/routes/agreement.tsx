...
const T = {
  en: {
    ...
    tos: [
      ...
      "DetencionDefensa.com is not your lawyer. Communications between you and DetencionDefensa.com staff are NOT protected by attorney-client privilege. A separate, limited attorney-client relationship with Rosario Sorrentino, Esq. is described in the Limited Retainer Agreement below; only your communications with the Attorney are privileged.",
  ...
  es: {
    ...
    tos: [
      ...
      "DetencionDefensa.com no es su abogado. Las comunicaciones entre usted y el personal de DetencionDefensa.com NO están protegidas por el privilegio abogado-cliente. Una relación abogado-cliente separada y limitada con Rosario Sorrentino, Esq. se describe en el Acuerdo Limitado de Retención abajo; solo sus comunicaciones con el Abogado son privilegiadas.",
