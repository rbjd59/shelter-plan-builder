...
const T = {
  en: {
    ...
    retainer: [
      ...
      "Attorney's fee for this limited representation is included in the monthly subscription to DetencionDefensa.com. Documents are prepared and reviewed at no additional charge and are non-refundable once review begins.",
  ...
  es: {
    ...
    retainer: [
      ...
      "La tarifa del Abogado por esta representación limitada está incluida en la suscripción mensual a DetencionDefensa.com. Los documentos se preparan y revisan sin costo adicional y no son reembolsables una vez iniciada la revisión.",
  ...
  ht: {
    ...
    retainer: [
      ...
      "Frè Avoka a pou reprezantasyon limite sa a enkli nan abònman chak mwa a DetencionDefensa.com. Dokiman yo prepare ak revize san frè adisyonèl epi pa ranbousab yon fwa revizyon an kòmanse.",
