...
const COPY = {
  en: {
    ...
    emergencyAppTitle: "Emergency App — no cost right now",
    ...
    subscribeBtn: "Get started — no cost →",
    recheck: "← Review my answers again",
  ...
  es: {
    ...
    emergencyAppTitle: "App de Emergencia — sin costo ahora",
    ...
    subscribeBtn: "Empezar — sin costo →",
  ...
  ht: {
    ...
    emergencyAppTitle: "App Ijans — san frè kounye a",
