...
const COPY: Record<Lang, {
  ...
  en: {
    ...
    priceLine: "$99 one-time + optional $5/month vault storage",
    intro: "For $99 we gather every document your family will need and translate them for you. You fill them out in your language — we translate your words exactly into English. You print, sign, and notarize.",
    ...
    storageOffer: "Encrypted on-device vault. Released only when you trigger HELP NOW.",
    ...
    packetCta: "Add Readiness Packet — $99",
  ...
  es: {
    ...
    priceLine: "$99 pago único + opcional $5/mes de bóveda",
    intro: "Por $99 reunimos todos los documentos que su familia necesitará y los traducimos para usted. Usted los llena en su idioma — nosotros traducimos sus palabras exactamente al inglés. Usted los imprime, firma y notariza.",
    ...
    storageOffer: "Bóveda cifrada en su dispositivo. Liberada solo cuando active AYUDA YA.",
    ...
    packetCta: "Agregar Paquete Readiness — $99",
    trustTitle: "Sentinel Trust — premium",
  ...
  ht: {
    ...
    priceLine: "$99 yon sèl fwa + opsyonèl $5/mwa pou kòfrefò",
    intro: "Pou $99 nou rasanble tout dokiman fanmi w ap bezwen e nou tradui yo pou ou. Ou ranpli yo nan lang ou — nou tradui pawòl ou yo egzakteman an Anglè. Ou enprime, siyen, e fè yo notarize.",
    ...
    storageOffer: "Kòfrefò chiffre nan aparèy ou. Lage sèlman lè ou aktive AYÈ KOUNYE A.",
    ...
    packetCta: "Ajoute Pakè Readiness — $99",
    trustTitle: "Sentinel Trust — premium",
