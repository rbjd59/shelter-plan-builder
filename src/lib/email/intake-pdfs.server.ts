...
async function fillAO242(a: A): Promise<Uint8Array> {
  ...
  // Question 2: name of institution / address. Filled from the locate desk
  // once the facility is known; left blank before detention so the
  // petitioner can handwrite it.
