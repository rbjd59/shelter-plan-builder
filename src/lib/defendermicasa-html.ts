 ...
 * The original CTA "Book a Consultation" link has its href swapped to
 * `#notify` so it scrolls to the React-rendered signup form.
 */
export const DEFENDER_HTML = `
<style>
  .dm-root {
    --ink: #0e1a2b;
    --ink-soft: #1a2940;
...
<nav class="nav">
  ...
  <a href="#notify" class="nav-cta">Notify Me →</a>
</nav>
...
<section class="hero">
  <div class="hero-text">
    ...
    <div class="hero-actions">
      <a href="#notify" class="btn-primary">Advise Me When Open <span>→</span></a>
...
<section class="statbar">
  <div class="stat"><div class="stat-num">5M+</div><div class="stat-label">Non-citizens projected to face removal in coming years</div></div>
  <div class="stat"><div class="stat-num">∞</div><div class="stat-label">Vehicles abandoned roadside daily during detention events</div></div>
  <div class="stat"><div class="stat-num">3</div><div class="stat-label">Average days before an unattended home faces real risk</div></div>
  <div class="stat"><div class="stat-num">0</div><div class="stat-label">Tolerance for losing what you spent decades building</div></div>
</section>
...
<section class="section" id="problem">
  ...
  <div class="problem-grid">
    <div class="problem"><div class="problem-num">i.</div><h3>Powers of attorney often fail</h3><p>Banks, title companies, and county recorders frequently refuse to honor informal POAs — especially across state lines or after long delays. The document that felt like protection becomes paper.</p></div>
    <div class="problem"><div class="problem-num">ii.</div><h3>Property goes dark fast</h3><p>Mortgages default. Insurance lapses. Squatters arrive. Tax liens accumulate. Within weeks of detention, decades of equity can quietly evaporate from a home no one can legally manage.</p></div>
    <div class="problem"><div class="problem-num">iii.</div><h3>Vehicles disappear into impound</h3><p>A car left where ICE made the stop becomes an impound fee, then an auction, then a stranger's title — usually within 30 days. The owner is in another country and has no legal way to recover it.</p></div>
  </div>
</section>
...
<section class="section solution" id="solution">
  ...
  <div class="pillars">
    <div class="pillar"><div class="pillar-icon">I</div><h3>The Revocable Living Trust</h3><p>You retain full control while in the country — buy, sell, refinance, anything. Real property is titled into the trust. A successor trustee, vetted and bonded, has standby authority that activates only on a verified triggering event.</p>
      <ul class="pillar-list"><li>Real property transfer</li><li>Standby successor trustee</li><li>Written instructions: hold, rent, or sell</li><li>International proceeds wiring</li></ul></div>
    <div class="pillar"><div class="pillar-icon">II</div><h3>Vehicle Recovery Protocol</h3><p>A dedicated limited POA, notarized in advance, paired with a designated agent and pre-built relationships at impound networks. Your designated agent recovers the vehicle within the 30-day window before auction.</p>
      <ul class="pillar-list"><li>Notarized vehicle authorization</li><li>Transfer-on-Death titling where available</li><li>Impound network coordination</li><li>Title transfer or sale on your direction</li></ul></div>
    <div class="pillar"><div class="pillar-icon">III</div><h3>Verified Trigger Protocol</h3><p>Authority does not transfer on a button press. It transfers on certified verification — ICE detainee locator confirmation, a defined no-contact window, family attestation, attorney sign-off. Title companies and courts accept the chain because we built it to survive scrutiny.</p>
      <ul class="pillar-list"><li>Multi-source verification</li><li>Attorney-certified authorization</li><li>Audit-ready documentation</li><li>Reversible if you return</li></ul></div>
    <div class="pillar"><div class="pillar-icon">IV</div><h3>Cross-Border Distribution</h3><p>An attorney-administered client trust account holds proceeds. KYC and OFAC compliance is built in. Funds reach you in your destination country through licensed channels — not through a friend's Venmo.</p>
      <ul class="pillar-list"><li>IOLTA-style client trust account</li><li>AML / OFAC compliance</li><li>Licensed international wire</li><li>Documented beneficiary designation</li></ul></div>
  </div>
</section>
...
<section class="section" id="process">
  ...
  <div class="process-steps">
    <div class="step"><div class="step-num">1</div><h4>Confidential Consultation</h4><p>An attorney-led intake in your language. We map your assets — home, vehicles, accounts — and your wishes. Free of charge, fully privileged.</p></div>
    <div class="step"><div class="step-num">2</div><h4>Document Preparation</h4><p>Trust drafted, deed prepared, vehicle authorizations notarized. Beneficiary chosen. Successor trustee designated. Instructions encoded.</p></div>
    <div class="step"><div class="step-num">3</div><h4>Funding &amp; Filing</h4><p>Title transferred. Records filed at the county. App linked. You receive a binder, a backup digital vault, and a card with the 24/7 line.</p></div>
    <div class="step"><div class="step-num">4</div><h4>Standby. Forever, if needed.</h4><p>Nothing changes day-to-day. You live your life. The structure waits. If the moment comes, it activates within hours — not weeks.</p></div>
  </div>
</section>
...
<section class="section trigger" id="app">
  <div class="trigger-text">
    ...
    <a href="#notify" class="btn-primary" style="background:var(--accent);">Advise Me When Open <span>→</span></a>
  </div>
  <div>
